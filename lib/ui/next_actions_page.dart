...
class NextActionsPage extends StatefulWidget {
  ...
  @override
  State<NextActionsPage> createState() => _NextActionsPageState();
}
...
class _NextActionsPageState extends State<NextActionsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final items = _getFilteredAndSortedItems(service.nextActionsItems);
      ...
      children: [
        ...
        Expanded(
          child: GtdItemListView(
            items: items,
            emptyListMessage: "Nenhuma próxima ação encontrada.",
